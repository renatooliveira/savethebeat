...
Bot: Click here to connect your Spotify account: https://your-domain.com/spotify/connect?slack_workspace_id=...
...
- ✅ **Connect Command** - Type `@savethebeat connect` to start OAuth flow
